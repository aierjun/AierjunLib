...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabchecktextcolor=0x000000;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabBackgroundDrawable = createColorStateListDrawable(Color.TRANSPARENT,getResources().getColor(android.R.color.transparent));
        ...
        if(a.hasValue(R.styleable.PagerSlidingTabStrip_pstsTabBackground)) tabBackgroundDrawable = a.getDrawable(R.styleable.PagerSlidingTabStrip_pstsTabBackground);
...
//            v.setBackgroundDrawable(tabBackgroundDrawable);
    ...
    public void setTabCheckTextColor(int resId){
        this.tabchecktextcolor = getResources().getColor(resId);
    }
